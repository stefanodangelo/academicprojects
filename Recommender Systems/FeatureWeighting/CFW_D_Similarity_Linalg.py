...
class CFW_D_Similarity_Linalg(BaseItemSimilarityMatrixRecommender):
    ...
    def fit(self, show_max_performance = False, logFile = None, loss_tolerance = 1e-6,
            iteration_limit = 50000, damp_coeff=0.0, topK = 300, shrink = 0, add_zeros_quota = 0.0, normalize_similarity = False):
        ...
        linalg_result = linalg.lsqr(commonFeatures, self.data_list, show = show_max_performance, atol=loss_tolerance, btol=loss_tolerance,
    ...
    def _compute_W_sparse(self, use_incremental = False):
        ...
        self.similarity = Compute_Similarity(self.ICM.T, shrink=self.shrink, topK=self.topK,
